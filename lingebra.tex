...
Pokud tedy chceme dostat něco užitečnějšího, musíme k problému přistoupit jinak. Na všechna lineární
zobrazení $\myspace{V}\rightarrow\myspace{W}$ prostorů s konečnou dimenzí můžeme koukat
jako na vektorový prostor: matice dvou zobrazení sečteme po složkách, násobení skalárem roznásobí
všechny složky. Čtenář si může za domácí úkol dokázat, že taková konstrukce splňuje axiomy
vektorového prostoru.

Naším cílem tedy bude pomocí Kroneckerova součinu zkonstruovat bázi prostoru lineárních zobrazení.
A samozřejmě se přímo nabízí zkonstruovat je z bází prostoru vektoru a kovektoru.

\begin{example}
Vezměme nejjednodušší příklad: dvourozměrný vektorový prostor $\myspace{V}$ a jeho duální prostor
$\mydual{V}$ s ortonormální bází.
\begin{equation*}

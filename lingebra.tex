...
\begin{proof}
Důkaz povedeme tradičně, že dokážeme oba směry ekvivalence. Směr ``generuje $\Rightarrow$ jednoznačná``
sporem:

\medskip\noindent
předpokládejme, že lineární zobrazení není jednoznačné, tzn. existují $F_1 \neq F_2$ taková, že

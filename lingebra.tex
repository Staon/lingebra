...
a prostor $\myspace{U}\otimes\myspace{V}$ jako \textit{tensorový součin prostorů} $\myspace{U}$
...
Zde do hry vstupuje první podmínka definice, kterou jsme prozatím ignorovali. Ta říká, že obrazy
...
Nezbývá nám než opět využít první bod definice tensorového součinu, který říká, že obrazy

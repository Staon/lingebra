...
vektor a dostanu tak jako výsledek sloupcový vektor. Je potřeba podotknout, že zde
se již nejedná o maticový součin, ale o obecnější \textbf{Kroneckerův součin}.
V případě násobení řádkového a sloupcového vektoru jsou oba shodné.

...
\begin{equation*}
\myscalar{K}=\mycoord{\varphi}^T\mycoord{x} = \myscalar{\varphi_1}\myscalar{x_1} + \cdots + \myscalar{\varphi_n}\myscalar{x_n}
\end{equation*}
...
na to koukat jako na vrstevnice plochy, která je vztyčená ve třetí ose. Čím větší je normála, tím
je tato plocha strmější.

Analogie s vrstevnicemi je všeobecně používaná. V učebnicích se kovektory na obrázcích často značí
